...
TEST_CASE("Compound addition binds to sparse_matrix&") {
	auto lhs = make_sparse_matrix<long long>(2, 3, {{0, 0, 1}, {1, 2, 1}});
	auto rhs = make_sparse_matrix<long long>(2, 3, {{0, 0, 2}, {1, 2, 2}});
	const auto expected = make_sparse_matrix<long long>(2, 3, {{0, 0, 3}, {1, 2, 3}});
...
TEST_CASE("Compound addition binds to sparse_matrix&&") {
	...
	lhs += make_sparse_matrix<long long>(2, 3, {{0, 0, 2}, {1, 2, 2}});
...
TEST_CASE("Zeroing elements via addition makes the matrix sparse") {
	auto lhs = make_sparse_matrix<long long>(2, 3, {{0, 0, 1}, {1, 2, 1}});
...
TEST_CASE("Adding to a sparse element reifies it") {
