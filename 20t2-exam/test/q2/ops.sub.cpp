...
TEST_CASE("Compound subtraction binds to sparse_matrix&") {
...
TEST_CASE("Compound subtration binds to sparse_matrix&&") {
...
TEST_CASE("Subtracting from a sparse element reifies it") {
	...
	CHECK(lhs == make_sparse_matrix<long long>(2, 2, {{0, 0, -1}, {1, 1, -1}}));
}